# ΠΥΛΗ ΚΟΙΝΩΝΙΚΗΣ ΜΕΡΙΜΝΑΣ Extensions v2.0.0

Επεκτάσεις για το ΠΥΛΗ ΚΟΙΝΩΝΙΚΗΣ ΜΕΡΙΜΝΑΣ που προσθέτουν προηγμένες λειτουργίες διαχείρισης χρηστών, ασφάλειας και ειδοποιήσεων.
...
Αυτές οι επεκτάσεις ακολουθούν την ίδια άδεια με το κύριο ΠΥΛΗ ΚΟΙΝΩΝΙΚΗΣ ΜΕΡΙΜΝΑΣ project.
...
**Συμβατότητα**: ΠΥΛΗ ΚΟΙΝΩΝΙΚΗΣ ΜΕΡΙΜΝΑΣ v1.x και νεότερες
