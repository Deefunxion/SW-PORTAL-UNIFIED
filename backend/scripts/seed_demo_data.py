    ...
    with app.app_context():
        ...
        demo_data = [
            ...
            },
            {
                ...
                "title": "Χειρισμός περιπτώσεων ελέγχου δομών ΜΦΕ",
                "description": "Πρακτικές οδηγίες για τη διεξαγωγή ελέγχων σε Μονάδες Φροντίδας Ηλικιωμένων",
                "user": admin,
                "posts": [
                    (admin, "Θέλω να μοιραστώ ορισμένες πρακτικές που ακολουθούμε κατά τον έλεγχο ΜΦΕ. Η τήρηση πρωτοκόλλου είναι κρίσιμη."),
            ...
            },
            {
                ...
                "description": "Η πύλη SW Portal αναβαθμίζεται με AI βοηθό",
                "user": admin,
                "posts": [
