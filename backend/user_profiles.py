...
# Import db and User from app.py
...
# The create_user_profile_routes function remains as is, but its call will be moved.
def create_user_profile_routes(app, db, User):
    ...
    from app import UserProfile, UserContact, UserBlock
