...
def _seed_decision_templates(db, DecisionTemplate):
    """Seed decision templates for all document types."""
    if DecisionTemplate.query.count() > 0:
        return

    # ── Camp License Template (based on real ΑΠΟΦΑΣΗ_ΚΑΤΑΣΚΗΝΩΣΗΣ_TEMPLATE.docx) ──
    camp_body = """<p>ΘΕΜΑ: Χορήγηση άδειας λειτουργίας παιδικής κατασκήνωσης με τον διακριτικό τίτλο «{{τίτλος_κατασκήνωσης}}» στην περιοχή {{τοποθεσία}} ιδιοκτησίας της εταιρείας με την επωνυμία: {{επωνυμία_εταιρείας}}</p>

<p><strong>ΑΠΟΦΑΣΗ</strong></p>
<p><strong>ΑΝΤΙΠΕΡΙΦΕΡΕΙΑΡΧΗ ΑΝΑΤΟΛΙΚΗΣ ΑΤΤΙΚΗΣ</strong></p>

<p>Έχοντας υπόψη:</p>

<p>1. Τον Ν.3852/2010 «Νέα Αρχιτεκτονική της Αυτοδιοίκησης και της Αποκεντρωμένης Διοίκησης – Πρόγραμμα Καλλικράτης» (ΦΕΚ 87/τ.Α'/07-06-2010), όπως ισχύει.</p>
<p>2. Τις διατάξεις του Π.Δ. 145/2010 (ΦΕΚ 238/τ.Α'/27-12-2010) «Οργανισμός Περιφέρειας Αττικής», όπως τροποποιήθηκε.</p>
<p>3. Την υπ'αρίθμ. 377930/22-03-2024 (ΦΕΚ Β' 2121/07-04-2024) Απόφαση Περιφερειάρχη περί «Μεταβίβασης αρμοδιοτήτων».</p>
<p>4. Το άρθρου 1 του Ν. 2345/1995 «Οργανωμένες υπηρεσίες παροχής προστασίας από φορείς κοινωνικής πρόνοιας και άλλες διατάξεις» (ΦΕΚ 213/1995 τ. A') όπως τροποποιήθηκε και ισχύει.</p>
<p>5. Την υπ'αρίθμ. Δ22/οικ. 37641/1450/22-08-2016 (ΦΕΚ Β' 2712/30-08-2016) Κ.Υ.Α «Καθορισμός όρων και προϋποθέσεων λειτουργίας κατασκηνώσεων».</p>
<p>6. Την με Αριθ Γ2β/147 (ΦΕΚ Β 21/22-1-1999) ΚΥΑ περί «Σύστασης Επιτροπών για Παιδική Προστασία».</p>
<p>7. Τον Ν.4280/2014 άρθρο 52 §10 και 11, άρθρο 53 § 1β «Περιβαλλοντική αναβάθμιση και ιδιωτική πολεοδόμηση».</p>
<p>8. Το άρθρο 114 παρ. 2 του Ν.5079/2023 (ΦΕΚ Α' 215) που παρατείνει την προθεσμία του άρθρου 52 παρ. 10 του Ν.4280/2014 έως 31 Δεκεμβρίου 2025.</p>
<p>9. Τις διατάξεις του Ν.3861/10 (ΦΕΚ 112/Α/13-07-2010) «Ενίσχυση της διαφάνειας — Πρόγραμμα ΔΙΑΥΓΕΙΑ».</p>
<p>10. Τα υπ'αρίθμ. Δ11/οικ. 5757/179/6-2-2019 και Δ11/οικ. 17938/715/18-4-2019 έγγραφα της Αναπληρώτριας Υπουργού Εργασίας.</p>
<p>11. Το υπ'αρίθμ. 5358/10-04-2025 έγγραφο του Υπουργείου Κοινωνικής Συνοχής και Οικογένειας.</p>
<p>12. Την υπ'αρίθμ. {{αριθμός_αίτησης}} / {{ημερομηνία_αίτησης}} αίτηση της αναφερόμενης στο Θέμα εταιρείας με τα νόμιμα δικαιολογητικά για τη χορήγηση άδειας λειτουργίας Παιδικής Κατασκήνωσης κατά την κατασκηνωτική περίοδο {{έτος}}.</p>
<p>13. Το από {{ημερομηνία_πρακτικού}} πρακτικό της αρμόδιας επιτροπής περί καταλληλότητας του χώρου και των εγκαταστάσεων.</p>
<p>14. Την υπ'αρίθμ. {{αριθμός_πυρασφάλειας}} βεβαίωση πυρασφάλειας η οποία ισχύει μέχρι {{λήξη_πυρασφάλειας}}.</p>
<p>15. Tο σχηματισθέντα φάκελο.</p>

<p><strong>ΑΠΟΦΑΣΙΖΟΥΜΕ</strong></p>

<p>1. Χορηγούμε στην εταιρεία {{επωνυμία_εταιρείας}} άδεια λειτουργίας Παιδικής Κατασκήνωσης με τον διακριτικό τίτλο «{{τίτλος_κατασκήνωσης}}» στην περιοχή {{τοποθεσία}} για την θερινή περίοδο του {{έτος}}, με τις παρακάτω προϋποθέσεις:</p>

<p>Α) Η παιδική εξοχή θα λειτουργήσει από {{ημερομηνία_έναρξης}} έως {{ημερομηνία_λήξης}} σε {{αριθμός_περιόδων}} κατασκηνωτικές περιόδους.</p>
<p>Η μέγιστη δυνατότητα εξυπηρέτησης ανέρχεται σε {{δυναμικότητα}} παιδιά.</p>
<p>Β) Τα παιδιά {{περιγραφή_ηλικιών_και_διαχωρισμού}}.</p>
<p>Γ) Η παιδική εξοχή να φέρει σε εμφανές σημείο της κύριας εισόδου πινακίδα με τίτλο κατασκήνωσης, αριθμό άδειας, ονοματεπώνυμο συντονιστή και υπεύθυνου κατασκηνωτικού φορέα, και στοιχεία επικοινωνίας.</p>
<p>Δ) Θα προσληφθεί το απαραίτητο προσωπικό και θα τηρηθεί το πρόγραμμα όπως δηλώθηκε.</p>
<p>Ε) Σε συνθήκες επιδημίας, τα μέτρα λειτουργίας προσαρμόζονται σύμφωνα με οδηγίες ΕΟΔΥ, Υπουργείου Υγείας και Υπ. Εργασίας.</p>
<p>ΣΤ) Δεν τίθεται περιορισμός σε λοιπές δραστηριότητες εκτός περιόδου λειτουργίας {{εκτός_περιόδου}}, υπό την προϋπόθεση εξασφάλισης ειδικής άδειας όπου απαιτείται.</p>

<p>2. Τυχόν παραβάσεις συνεπάγονται κυρώσεις κατά τις σχετικές διατάξεις.</p>

<p>{{ονοματεπώνυμο_αντιπεριφερειάρχη}}<br/>Αντιπεριφερειάρχης Ανατολικής Αττικής</p>"""

    camp_schema = {
        'fields': [
            {'key': 'έτος', 'label': 'Έτος', 'type': 'number', 'required': True},
            {'key': 'τίτλος_κατασκήνωσης', 'label': 'Διακριτικός τίτλος κατασκήνωσης', 'type': 'text', 'required': True},
            {'key': 'επωνυμία_εταιρείας', 'label': 'Επωνυμία εταιρείας', 'type': 'text', 'required': True},
            {'key': 'τοποθεσία', 'label': 'Τοποθεσία', 'type': 'text', 'required': True},
            {'key': 'ημερομηνία_έναρξης', 'label': 'Ημερομηνία έναρξης', 'type': 'date', 'required': True},
            {'key': 'ημερομηνία_λήξης', 'label': 'Ημερομηνία λήξης', 'type': 'date', 'required': True},
            {'key': 'αριθμός_περιόδων', 'label': 'Αριθμός κατασκηνωτικών περιόδων', 'type': 'number', 'required': True},
            {'key': 'δυναμικότητα', 'label': 'Μέγιστη δυναμικότητα (παιδιά)', 'type': 'number', 'required': True},
            {'key': 'περιγραφή_ηλικιών_και_διαχωρισμού', 'label': 'Ηλικίες & διαχωρισμός', 'type': 'text', 'required': True},
            {'key': 'εκτός_περιόδου', 'label': 'Δραστηριότητες εκτός περιόδου', 'type': 'text', 'required': False},
            {'key': 'αριθμός_αίτησης', 'label': 'Αριθμός αίτησης', 'type': 'text', 'required': False},
            {'key': 'ημερομηνία_αίτησης', 'label': 'Ημερομηνία αίτησης', 'type': 'date', 'required': False},
            {'key': 'ημερομηνία_πρακτικού', 'label': 'Ημερομηνία πρακτικού επιτροπής', 'type': 'date', 'required': False},
            {'key': 'αριθμός_πυρασφάλειας', 'label': 'Αρ. βεβαίωσης πυρασφάλειας', 'type': 'text', 'required': False},
            {'key': 'λήξη_πυρασφάλειας', 'label': 'Λήξη πυρασφάλειας', 'type': 'date', 'required': False},
            {'key': 'ονοματεπώνυμο_αντιπεριφερειάρχη', 'label': 'Ονοματεπώνυμο Αντιπεριφερειάρχη', 'type': 'text', 'required': False},
        ]
    }
    ...
    camp_legal = [
        ...
        'Δ22/οικ. 37641/1450/2016 ΚΥΑ «Όροι λειτουργίας κατασκηνώσεων»',
        'Γ2β/147 (ΦΕΚ Β 21/1999) ΚΥΑ «Σύσταση Επιτροπών Παιδικής Προστασίας»',
        'Ν.4280/2014 «Περιβαλλοντική αναβάθμιση»',
        'Ν.5079/2023 άρθρο 114 παρ. 2',
        'Ν.3861/10 «Πρόγραμμα ΔΙΑΥΓΕΙΑ»',
    ]

    camp_recipients = [
        {'name': 'Υπουργείο Εργασίας και Κοινωνικών Υποθέσεων – Δ/νση Προστασίας Οικογένειας'},
        {'name': 'Ε.Α.Δ. – Σώμα Επιθεωρητών Υγείας και Πρόνοιας'},
        {'name': 'Αστυνομικό Τμήμα {{τοπικό_ΑΤ}}'},
    ]

    db.session.add(DecisionTemplate(
        type='camp_license',
        title='Άδεια Λειτουργίας Παιδικής Κατασκήνωσης',
        description='Απόφαση χορήγησης άδειας λειτουργίας παιδικής κατασκήνωσης '
                    'σύμφωνα με τη Δ22/οικ.37641/1450/2016 ΚΥΑ.',
        body_template=camp_body,
        legal_references=camp_legal,
        schema=camp_schema,
        recipients_template=camp_recipients,
        structure_type_code='CAMP',
        is_active=True,
        version=1,
    ))
    db.session.flush()
